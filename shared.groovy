...
def populateData(ctx) {
  ...
  sh "${ctx.sshCmd} -l ${ctx.sshUser} ${ctx.okapiIp} docker run --rm -e TENANT_ID=supertenant -e ADMIN_USER=admin -e ADMIN_PASSWORD=admin -e OKAPI_URL=http://${ctx.okapiIp}:9130 folioci/bootstrap-superuser"
}
